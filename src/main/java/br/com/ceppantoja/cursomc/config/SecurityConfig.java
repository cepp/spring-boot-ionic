...
import br.com.ceppantoja.cursomc.filter.JWTAuthenticationFilter;
import br.com.ceppantoja.cursomc.filter.JWTAuthorizationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private static final String[] PUBLIC_MATCHERS = {"/h2_console/**"};
